...
public class ExRAdapter extends ArrayAdapter {
    public ExRAdapter(@NonNull Context context, int resource, @NonNull List objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull final ViewGroup parent) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((SettingRou)(parent.getContext())).deleteData(myItem.getName());
                ((SettingRou)(parent.getContext())).updateListView();
            }
        });
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(parent.getContext(),Plus_R.class);
